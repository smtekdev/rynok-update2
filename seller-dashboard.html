...
<body>
    ...
    <div class="header-cart-wrap rev-7-header-cart-wrap" id="headerCartWrap">
        <div class="cart-list">
            <div class="title">
                <h3>Shopping Cart</h3>
    ...
    <div class="header-cart-wrap rev-7-header-cart-wrap" id="headerWishWrap">
        <div class="cart-list">
            <div class="title">
                <h3>Wish List</h3>
                            ...
                            <ul class="top-header-link justify-content-lg-end justify-content-center">
                                ...
                                <li>
                                    <!-- <div class="select-language">
                                        <div class="language">
                                            <div >
                                                <div id="aw" style="color:white;" data-input-name="country" data-selected-country="UK" data-scrollable-height="250px">
                                ...
                                <div class="col-xxl-5 col-lg-4 col-md-3 col-sm-4 col-7">
                                    <ul class="bottom-header-right d-flex align-items-center justify-content-end">
                                        <li class="header-cart-options">
                                            ...
                                            <a href="login.html" class="compare-list-btn">
                                             Sign in
                                            </a>
                                            <a href="#" class="compare-list-btn">
                                               /
                                               </a>
                                               <button id="myBtn" style="font-size: 22px;color:#7E7E7E;font-weight: 500;">Sign up</button>
                                               <div id="myModal" class="modal">
                                    
                                                <!-- Modal content -->
                                                <div class="modal-content">
                                                  <span class="close">&times;</span>
                                                  <a href="user-signup.html" style="width: 57%; margin-left:19%;" class="def-btn rev-6-def-btn">User Signup</a>
                                                  <br>
                                                  <a href="vendor-signup.html" style="width: 68%; margin-left:14%;" class="def-btn rev-6-def-btn">Vendor Signup</a>
                                                </div>
                        ...
                        <div class="container">
                            <div class="row align-items-center">
                                                    ...
                                                    <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                                                        ...
                                                        <li class="nav-item dropdown">
                                                            ...
                                                            <ul class="dropdown-menu" aria-labelledby="shopDropdown">
                                                                <li style="width: 250px;"><a class="dropdown-item" href="health-&-beauty.html">Health & Beauty</a></li>
                                                                <li style="width: 250px;"><a class="dropdown-item" href="home-services.html">Home Services</a></li>
                                                                <li style="width: 250px;"><a class="dropdown-item" href="fashion.html">Fashion</a></li><br>
                                                                <li style="width: 250px;"><a class="dropdown-item" href="sports.html">Sports</a></li>
                                                        ...
                                                        <li class="nav-item dropdown">
                                                            ...
                                                            <ul class="dropdown-menu" aria-labelledby="shopDropdown">
                                                                <li style="width: 250px;"><a class="dropdown-item" href="salon-&-spa.html">Salon & Spa</a></li>
                                                                <li style="width: 250px;"><a class="dropdown-item" href="food-&-drink.html">Food & Drink</a></li>
                                                                <li style="width: 250px;"><a class="dropdown-item" href="clothing.html">Clothing</a></li>
                                                                <li style="width: 250px;"><a class="dropdown-item" href="home-appliances-coupons.html">Home Appliances</a></li>
                                                                <li style="width: 250px;"><a class="dropdown-item" href="fun-&-entertainment.html">Fun & Entertainment</a></li>
                                                                <li style="width: 250px;"><a class="dropdown-item" href="sports-&-fitness.html">Sports & Fitness</a></li>
                                                                <li style="width: 250px;"><a class="dropdown-item" href="department-stores.html">Department Stores</a></li>
                                                            </ul>
                                                        </li>
                                                        <li class="nav-item dropdown">
                                                            ...
                                                            <ul class="dropdown-menu" aria-labelledby="pageDropdown">
                                                                <li style="width: 250px;"><a class="dropdown-item" href="home-appliances.html">Home Appliances</a></li>
                                                                <li style="width: 250px;"><a class="dropdown-item" href="automotive.html">Automotive</a></li>
                                                                <li style="width: 250px;"><a class="dropdown-item" href="furniture-&-home-decor.html">Furniture & Home decor</a></li>

                                                                <li style="width: 250px;"><a class="dropdown-item" href="kids-entertainment.html">Kids Entertainment</a></li>
                                                                <!-- <li style="width: 250px;"><a class="dropdown-item" href="wishlist.html">Wishlist</a></li>
                                                                <li style="width: 250px;"><a class="dropdown-item" href="register.html">Register Page</a></li> -->
                                                            </ul>
                                                        </li>
                                                        <li class="nav-item dropdown">
                                                            ...
                                                            <ul class="dropdown-menu" aria-labelledby="blogDropdown">
                                                                <li style="width: 250px;"><a class="dropdown-item" href="rent-a-chair-in-salon.html">Rent a Chair in Salon</a></li>
                                                                <li style="width: 250px;"><a class="dropdown-item" href="rent-a-house.html">Rent a House / Room</a></li>
                                                                <li style="width: 250px;"><a class="dropdown-item" href="rent-an-office.html">Rent an Office</a></li>

                                                                <li style="width: 250px;"><a class="dropdown-item" href="buying-&-selling.html">Buying & Selling</a></li>
                                                            </ul>
                                                        </li>
                                                        <li class="nav-item dropdown">
                                                            <a class="nav-link dropdown-toggle" href="#" id="blogDropdown" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                                                            ...
                                                            <ul class="dropdown-menu" aria-labelledby="blogDropdown">
                                                                <li style="width: 250px;"><a class="dropdown-item" href="digital-world.html">Digital Services</a></li>
                                                                <li style="width: 250px;"><a class="dropdown-item" href="beauty-&-spa.html">Beauty & Spa</a></li>
                                                                <li style="width: 250px;"><a class="dropdown-item" href="things-to-do.html">Things to do</a></li>
                                                                <li style="width: 250px;"><a class="dropdown-item" href="restaurant.html">Restaurant</a></li>
                                                                <li style="width: 250px;"><a class="dropdown-item" href="hotels-&-travels.html">Hotels & Travels</a></li>
                                                                <li style="width: 250px;"><a class="dropdown-item" href="health-&-fitness.html">Health & Fitness</a></li>
                                                            </ul>
                                                        </li>
                                                        ...
                                                        <li class="nav-item dropdown">
                                                            ...
                                                            <ul class="dropdown-menu" aria-labelledby="blogDropdown">
                                                                <li style="width: 250px;"><a class="dropdown-item" href="aromatherapy.html">Aromatherapy</a></li>
                                                                <li style="width: 250px;"><a class="dropdown-item" href="medical-services.html">Medical Services</a></li>
                                                                <li style="width: 250px;"><a class="dropdown-item" href="orthopaedic-therapy.html">Orthopaedic Therapy</a></li>
                                                                <li style="width: 250px;"><a class="dropdown-item" href="restaurant.html">Restaurant</a></li>
                                                                <li style="width: 250px;"><a class="dropdown-item" href="dance-sessions.html">	Dance Sessions</a></li>
                                                                <li style="width: 250px;"><a class="dropdown-item" href="fitness-classes.html">Fitness Classes</a></li>
                                                            </ul>
                                                        </li>
                                                    </ul>
                                                </nav>
                                ...
                                <!-- <div class="col-lg-3">
                                    <div class="live-chat">
                                        <div class="icon">
                                            <img src="assets/images/icons/help-center-icon.png" alt="icon">
                                        </div>
                                        <div class="txt">
                                            <span class="d-block">Hotline Free:</span>
                                            <a class="d-block" href="tel:+997509153">(+100) 123 456 7890)</a>
                                        </div>
                                    </div>
                                </div> -->
                            </div>
                ...
                <div class="col-xxl-3 col-lg-4">
                    <div class="dashboard-left-sidebar">
                            ...
                            <div class="profile-contain">
                                <div class="profile-image">
                                    <div class="position-relative">
                                        <img src="assets/images2/vendor-page/logo.png" class="blur-up lazyload update_img" alt="">
                        ...
                        <ul class="nav nav-pills user-nav-pills" id="pills-tab" role="tablist">
                            ...
                            <li class="nav-item" role="presentation">
                                <button class="nav-link" id="pills-product-tab" data-bs-toggle="pill" data-bs-target="#pills-product" type="button" role="tab" aria-controls="pills-product" aria-selected="false"><i data-feather="shopping-bag"></i>Products</button>
                            </li>
                            ...
                            <li class="nav-item" role="presentation">
                                <button class="nav-link" id="pills-security-tab" data-bs-toggle="pill" data-bs-target="#pills-security" type="button" role="tab" aria-controls="pills-security" aria-selected="false"><i data-feather="settings"></i>
                                    Setting</button>
                            </li>
                                ...
                                <div class="dashboard-profile">
                                    ...
                                    <div class="profile-tab dashboard-bg-box">
                                        <div class="dashboard-title dashboard-flex">
                                            <h3>Profile Name</h3>
                                            <button class="btn btn-sm theme-bg-color text-white" data-bs-toggle="modal" data-bs-target="#edit-profile">Edit Profile</button>
                                        </div>
