...
<!-- Mirrored from revelecommerce.codebasket.net/revel/# by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 05 Mar 2023 09:47:06 GMT -->
<head>
    <meta charset="UTF-8">
                                                    ...
                                                    <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                                                        ...
                                                        <li class="nav-item dropdown">
                                                            ...
                                                            <ul class="dropdown-menu" aria-labelledby="shopDropdown">
                                                                <li><a class="dropdown-item" href="health-&-beauty.html">Health & Beauty</a></li>
                                                                <li><a class="dropdown-item" href="home-services.html">Home Services</a></li>
                                                        ...
                                                        <li class="nav-item dropdown">
                                                            ...
                                                            <ul class="dropdown-menu" aria-labelledby="shopDropdown">
                                                                <li><a class="dropdown-item" href="salon-&-spa.html">Salon & Spa</a></li>
                                                                <li><a class="dropdown-item" href="food-&-drink.html">Food & Drink</a></li>
                                                                <li><a class="dropdown-item" href="clothing.html">Clothing</a></li>
                                                                <li><a class="dropdown-item" href="home-appliances-coupons.html">Home Appliances</a></li>
                                                                <li><a class="dropdown-item" href="fun-&-entertainment.html">Fun & Entertainment</a></li>
                                                                <li><a class="dropdown-item" href="sports-&-fitness.html">Sports & Fitness</a></li>
                                                        ...
                                                        <li class="nav-item dropdown">
                                                            ...
                                                            <ul class="dropdown-menu" aria-labelledby="pageDropdown">
                                                                ...
                                                                <li><a class="dropdown-item" href="furniture-&-home-decor.html">Furniture & Home decor</a></li>

                                                                <li><a class="dropdown-item" href="kids-entertainment.html">Kids Entertainment</a></li>
                                                        ...
                                                        <li class="nav-item dropdown">
                                                            ...
                                                            <ul class="dropdown-menu" aria-labelledby="blogDropdown">
                                                                <li><a class="dropdown-item" href="rent-a-chair-in-salon.html">Rent a Chair in Salon</a></li>
                                                                <li><a class="dropdown-item" href="rent-a-house.html">Rent a House / Room</a></li>
                                                                <li><a class="dropdown-item" href="rent-an-office.html">Rent an Office</a></li>

                                                                <li><a class="dropdown-item" href="buying-&-selling.html">Buying & Selling</a></li>
                                                            </ul>
                                                        </li>
                                                        <li class="nav-item dropdown">
                                                            <a class="nav-link dropdown-toggle" href="#" id="blogDropdown" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                                                            ...
                                                            <ul class="dropdown-menu" aria-labelledby="blogDropdown">
                                                                <li><a class="dropdown-item" href="digital-world.html">Digital Services</a></li>
                                                                <li><a class="dropdown-item" href="beauty-&-spa.html">Beauty & Spa</a></li>
                                                                <li><a class="dropdown-item" href="things-to-do.html">Things to do</a></li>
                                                                <li><a class="dropdown-item" href="restaurant.html">Restaurant</a></li>
                                                                <li><a class="dropdown-item" href="hotels-&-travels.html">Hotels & Travels</a></li>
                                                                <li><a class="dropdown-item" href="health-&-fitness.html">Health & Fitness</a></li>
                                                            </ul>
                                                        </li>
                                                        ...
                                                        <li class="nav-item dropdown">
                                                            ...
                                                            <ul class="dropdown-menu" aria-labelledby="blogDropdown">
                                                                <li><a class="dropdown-item" href="aromatherapy.html">Aromatherapy</a></li>
                                                                <li><a class="dropdown-item" href="medical-services.html">Medical Services</a></li>
                                                                <li><a class="dropdown-item" href="orthopaedic-therapy.html">Orthopaedic Therapy</a></li>
                                                                <li><a class="dropdown-item" href="restaurant.html">Restaurant</a></li>
                                                                <li><a class="dropdown-item" href="dance-sessions.html">	Dance Sessions</a></li>
                                                                <li><a class="dropdown-item" href="fitness-classes.html">Fitness Classes</a></li>
                                                            </ul>
                                                        </li>
                                                    </ul>
                                                </nav>
            ...
            <ul class="menu-bar">
                ...
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li><a href="index-3.html" class="dropdown-item">Home Page 03</a></li>
                        <li><a href="index-4.html" class="dropdown-item">Home Page 04</a></li>
                        <li><a href="index-5.html" class="dropdown-item">Home Page 05</a></li>
                        <li><a href="index-6.html" class="dropdown-item">Home Page 06</a></li>
                        <li><a href="index-7.html" class="dropdown-item">Home Page 07</a></li>
                        <li><a href="index-8.html" class="dropdown-item">Home Page 08</a></li>
                    </ul>
                </li>
                <li class="nav-item">
            ...
            <div class="row justify-content-between align-items-center">
                <div class="col-lg-6 col-md-9 col-8">
                    <div class="breadcrumb-txt">
                        <h1>Shop Details</h1>
                        <ul>
                            <li><a href="index.html"><i class="fa-regular fa-house"></i></a></li>
                            <li>/</li>
                            <li>Shop Details</li>
                        </ul>
                    </div>
                ...
                <div class="col-12">
                    <div class="related-product-slider owl-carousel">
                        <div class="single-product-card">
                            ...
                            <div class="part-txt">
                                <h4 class="product-name"><a href="#">Casual Walking Sneaker</a></h4>
                        ...
                        <div class="single-product-card">
                            ...
                            <div class="part-txt">
                                <h4 class="product-name"><a href="#">Sports Water Bottle</a></h4>
                                <p class="dscr">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Ducimus aliquid laborum aperiam dolores. Dignissimos at harum corporis qui illo nam fugit recusandae ratione odit neque officia, accusamus ab, assumenda odio.</p>
                                <p class="price"><span>$96.00</span>$75.00</p>
                                <div class="star">
                                    <i class="fa-solid fa-star-sharp rated"></i>
                        ...
                        <div class="single-product-card">
                            ...
                            <div class="part-txt">
                                <h4 class="product-name"><a href="#">Mithai Black Forest Cake</a></h4>
                                <p class="dscr">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Ducimus aliquid laborum aperiam dolores. Dignissimos at harum corporis qui illo nam fugit recusandae ratione odit neque officia, accusamus ab, assumenda odio.</p>
                                <p class="price"><span>$96.00</span>$75.00</p>
                                <div class="star">
                                    <i class="fa-solid fa-star-sharp rated"></i>
                        ...
                        <div class="single-product-card">
                            ...
                            <div class="part-txt">
                                <h4 class="product-name"><a href="#">Kerayin 55 Momentum</a></h4>
                                <p class="dscr">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Ducimus aliquid laborum aperiam dolores. Dignissimos at harum corporis qui illo nam fugit recusandae ratione odit neque officia, accusamus ab, assumenda odio.</p>
                                <p class="price"><span>$96.00</span>$75.00</p>
                                <div class="star">
                                    <i class="fa-solid fa-star-sharp rated"></i>
                        ...
                        <div class="single-product-card">
                            ...
                            <div class="part-txt">
                                <h4 class="product-name"><a href="#">Gamepad Controller</a></h4>
                                <p class="dscr">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Ducimus aliquid laborum aperiam dolores. Dignissimos at harum corporis qui illo nam fugit recusandae ratione odit neque officia, accusamus ab, assumenda odio.</p>
                                <p class="price"><span>$96.00</span>$75.00</p>
                                <div class="star">
                                    <i class="fa-solid fa-star-sharp rated"></i>
                        ...
                        <div class="single-product-card">
                            ...
                            <div class="part-txt">
                                <h4 class="product-name"><a href="#">Fried Rice Set Menu</a></h4>
                                <p class="dscr">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Ducimus aliquid laborum aperiam dolores. Dignissimos at harum corporis qui illo nam fugit recusandae ratione odit neque officia, accusamus ab, assumenda odio.</p>
                                <p class="price"><span>$96.00</span>$75.00</p>
                                <div class="star">
                                    <i class="fa-solid fa-star-sharp rated"></i>
...
<!-- Mirrored from revelecommerce.codebasket.net/revel/# by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 05 Mar 2023 09:47:14 GMT -->
</html>